...
class AppPaddings {
  ...
  static final EdgeInsets all8 = EdgeInsets.all(8);
  //symmetric
  ...
  static final EdgeInsets right8 = EdgeInsets.only(right: 8.0);
  //left
  static final EdgeInsets left10 = EdgeInsets.only(left: 5);
  static final EdgeInsets left20 = EdgeInsets.only(left: 20);
  //top
  static final EdgeInsets top10 = EdgeInsets.only(top: 10.0);
  static final EdgeInsets top8 = EdgeInsets.only(top: 8.0);
  //appBar
